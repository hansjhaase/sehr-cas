...
public class UAgentInfo {
   ...
   * these devices will have 'Android' AND 'mobile' in user agent. Ignores
   ...
   * capable recent browser. Excludes the Playbook. Examples, Storm, Bold, Tour,
   * Curve2 Excludes the new BlackBerry OS 6 and 7 browser!!
   *
  ...
  /**
   * Detects if the current device is an Internet-capable game console. Includes
   * many handheld consoles.
   *
   ...
   * touchscreen and modern iPhone-class browser. Includes the Playstation Vita.
   *
  ...
  /**
   * Detects if the current device is a mobile device. This method catches most
   * of the popular modern devices. Excludes Apple iPads and other modern
   * tablets.
   *
   ...
   * iPod Touch, Android, Windows Phone 7 and 8, BB10, WebOS, Playstation Vita,
   * etc.
   *
